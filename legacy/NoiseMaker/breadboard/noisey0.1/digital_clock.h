...
#define btn_one			TRISB0
#define btn_two			TRISB1
#define btn_three		TRISB2

#define btn_one			RB0
#define btn_two			RB1
#define btn_three		RB2
...
//bit alarm=0;
unsigned char outString[3];
unsigned char period = 240;
unsigned char prescale_option = 1;
bit update_display = 0;
